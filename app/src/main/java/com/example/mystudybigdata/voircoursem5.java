...
public class voircoursem5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voircoursem5);
        ...
        ImageButton retour = findViewById(R.id.home6);
        retour.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent_retour = new Intent(voircoursem5.this,Activity2.class);

...
public class voircoursem3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voircoursem3);
        ...
        retour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent_retour = new Intent(voircoursem3.this,Activity2.class);
                int id=getIntent().getIntExtra("studentId",1);
                String username=getIntent().getStringExtra("username");
                intent_retour.putExtra("studentId",id);
                intent_retour.putExtra("username",username);
